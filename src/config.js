...
export const MEME_MAP = [
  // === 身体动作 (Pose-based, 15) ===
  {
    ...
    meme: `${BASE}memes/panda-cover-face.svg`, category: '熊猫头',
  },
  {
    ...
    meme: `${BASE}memes/panda-hands-up.svg`, category: '熊猫头',
  },
  {
    ...
    meme: `${BASE}memes/haaland-smile.svg`, category: '哈兰德',
  },
  {
    ...
    meme: `${BASE}memes/possum-calm.svg`, category: '负鼠',
  },
  {
    ...
    meme: `${BASE}memes/homelander-shake.svg`, category: '黑袍纠察队',
  },
  {
    ...
    meme: `${BASE}memes/huh-cat.svg`, category: '猫Meme',
  },
  {
    ...
    meme: `${BASE}memes/happy-cat.svg`, category: '猫Meme',
  },
  {
    ...
    meme: `${BASE}memes/mooncat-heart.svg`, category: '月薪喵',
  },
  {
    ...
    meme: `${BASE}memes/panda-just-this.svg`, category: '熊猫头',
  },
  {
    ...
    meme: `${BASE}memes/panda-dunno.svg`, category: '熊猫头',
  },
  {
    ...
    meme: `${BASE}memes/panda-crash.svg`, category: '熊猫头',
  },
  {
    ...
    meme: `${BASE}memes/grass-cow-bye.svg`, category: '草地牛',
  },
  {
    ...
    meme: `${BASE}memes/haaland-thumbsup.svg`, category: '哈兰德',
  },
  {
    ...
    meme: `${BASE}memes/panda-please.svg`, category: '熊猫头',
  },
  {
    ...
    meme: `${BASE}memes/genshin-uchiha.svg`, category: '原神牛逼',
  },
  ...
  },
  {
    ...
    meme: `${BASE}memes/panda-wink.svg`, category: '熊猫头',
  },
  {
    id: 'pout', name: '嘟嘴', type: 'face',
    trigger: (bs) => bs.mouthPucker > 0.35,
    meme: `${BASE}memes/mooncat-smell.svg`, category: '月薪喵',
  },
  {
    id: 'eyes-closed', name: '崩溃/闭眼', type: 'face',
    trigger: (bs) => (bs.eyeBlinkLeft + bs.eyeBlinkRight) / 2 > 0.5,
    meme: `${BASE}memes/smile-crash-cat.svg`, category: '猫Meme',
  },
];
...
export const DEFAULT_MEME = {
  ...
  trigger: () => true,
  meme: `${BASE}memes/default-waiting.svg`, category: '系统',
};
